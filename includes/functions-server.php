...
function ensure_db_schema() {
    ...
    $alterStatements = [
        ...
        'CREATE UNIQUE INDEX IF NOT EXISTS product_images_product_type_idx ON product_images (product_id, image_type)',
        'CREATE UNIQUE INDEX IF NOT EXISTS product_inventory_product_idx ON product_inventory (product_id)',
        'CREATE UNIQUE INDEX IF NOT EXISTS product_descriptions_product_lang_idx ON product_descriptions (product_id, language_code)',
    ];
