            ...
            <div class="color-customizer">
                <div class="color-group">
                    ...
                    <div class="color-inputs">
                        ...
                        <div class="color-input-item">
                            <label for="color-primary-hover">Primary Hover:</label>
                ...
                <div class="color-group">
                    ...
                    <div class="color-inputs">
                        <div class="color-input-item">
                            <label for="color-bg-primary">Background:</label>
                ...
                <div class="color-group">
                    ...
                    <div class="color-inputs">
                        ...
                        <div class="color-input-item">
                            <label for="color-text-secondary">Text Secondary:</label>
...
.theme-card.active {
    border-color: var(--primary);
    box-shadow: 0 0 0 3px var(--color-purple-alpha-20);
}
...
<script src="assets/js/theme-admin.js"defer></script>
