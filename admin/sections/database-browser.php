...
.table-list a:hover { background: var(--bg-hover); }
.table-list a.active { 
    ...
    <div class="db-browser">
        ...
        <div class="db-sidebar">
            ...
            <ul class="table-list">
                ...
                <li style="border-bottom: 1px solid var(--border-color); margin: 10px 0;"></li>
                ...
                <div class="card">
                    ...
                    <?php if (!empty($tableStructure)): ?>
                        <details style="margin-bottom: 20px;">
                            <summary style="cursor: pointer; font-weight: 600; padding: 10px; background: var(--bg-secondary); border-radius: 4px; color: var(--text-primary);">
