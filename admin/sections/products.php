...
<div>
    <div class="section-header">
        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            <input type="text"id="productSearch"placeholder="🔍 <?php echo __('search'); ?>..."style="padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; min-width: 250px;"onkeyup="filterProducts()">
            ...
            <?php else: ?>
                <?php foreach ($products as $id => $product): ?>
                    <tr>
                        ...
                        <td><?php echo $currency_symbol; ?><?php echo number_format($product['price'], 2); ?></td>
    ...
    tr:has(.product-checkbox:checked) {
        background-color: var(--color-purple-alpha-10);
    }
    </style>
